...
@section('content')
    <section class="p-4 bg-white rounded-xl lg:p-5 mb-5 shadow-lg">
        ...
        <form action="{{ route('admin.update-mobil', ['id' => $mobil->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-5">
                        ...
                        <tr>
                            ...
                            <td class="h-full">
                                <form id="delete-form-{{ $gambar->id }}"
                                    action="{{ route('admin.delete-gambar-mobil', $gambar->id) }}" method="POST"
                                    class="w-full block">
                                    @csrf
                                    @method('DELETE')
    ...
    <div id="modal-tambah-gambar" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form action="{{ route('admin.store-gambar-mobil') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Modal body -->
