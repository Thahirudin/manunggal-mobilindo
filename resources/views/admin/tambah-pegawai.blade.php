...
@section('title', 'Tambah Data Pegawai | ' . config('app.name'))
...
@section('content')
    <section class="p-4 bg-white rounded-xl lg:p-5 mb-5 shadow-lg">
        <div class="mb-5">
            <p class="text-xl font-bold">Tambah Data Pegawai</p>
        </div>
        <form action="{{ route('admin.store-pegawai') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="nama" name="nama"
                    ...
                    placeholder="Robi Sugara" required />
                @error('ttl')
            ...
            <div class="mb-5">
                ...
                <input type="email" id="email" name="email"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="robisugara@gmail.com" required />
                @error('email')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-5">
                ...
                <input name="gambar"
                    ...
                    id="gambar" type="file" required accept="image/*">
                @error('gambar')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                @enderror
            </div>
