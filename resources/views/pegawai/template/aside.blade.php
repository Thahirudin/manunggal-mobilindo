    ...
    <aside id="default-sidebar" aria-label="Sidebar"
        ...
        <div class="bg-white border lg:rounded-xl p-4 h-[100%] w-full shadow-lg">
            <ul>
                <li class="">
                    <a href="{{ route('pegawai.dashboard') }}" class="p-3 block text-xl font-bold rounded-xl text-[#CE0000]">MANUNGGAL
                        MOBILINDO</a>
                </li>
                <li class="">
                ...
                <li class="">
                    <a href="{{ route('pegawai.data-mobil') }}"
                ...
                <li class="">
                    <a href="{{ route('pegawai.data-banner') }}"
